...
![](p8105_hw3_xz3173_files/figure-gfm/unnamed-chunk-12-1.png)<!-- -->
...
ggplot(inspection_activity, aes(x = Minute, y = Activity, color = sex)) +
  ...
  labs(title = "24-hour Activity Time Course by Education Level",
       x = "Time of Day (in minutes since midnight",
       y = "Activity") +
  theme_minimal()
```

![](p8105_hw3_xz3173_files/figure-gfm/unnamed-chunk-19-1.png)<!-- -->
